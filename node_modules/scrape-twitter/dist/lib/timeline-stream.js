...
var TimelineStream = function (_Readable) {
  ...
  function TimelineStream(username) {
    ...
    _this.count = count;
    _this.env = env;
    debug('TimelineStream for ' + _this.username + ' created with', {
      retweets: _this.retweets,
      replies: _this.replies,
      count: _this.count
    });
    return _this;
  }
  ...
  _createClass(TimelineStream, [{
    ...
    value: function _read() {
      ...
      loginWhenReplies(this.replies, this.env).then(function () {
        return twitterQuery.getUserTimeline(_this2.username, _this2._lastReadTweetId, {
          replies: _this2.replies
